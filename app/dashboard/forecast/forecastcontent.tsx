                ...
                <div className="bg-white rounded-2xl shadow-lg w-full max-w-4xl flex flex-col md:flex-row">
                    ...
                    <div className="w-full md:w-72 p-4 md:p-6 border-b md:border-b-0 md:border-r border-gray-100">
                        ...
                        <nav className="space-y-2 md:space-y-4">
                            <button className="w-full flex items-center text-sm px-3 md:px-4 py-2 bg-gray-50 rounded-lg text-gray-700">
                                <ListPlus className="w-4 h-4 mr-3" />
                                Type of forecast
                            </button>
                            <button className="w-full flex items-center text-sm px-3 md:px-4 py-2 text-gray-700">
                                <SlidersHorizontal className="w-4 h-4 mr-3" />
                                Fill demand
                                <span className="ml-2 text-xs bg-blue-100 text-blue-600 px-2 py-0.5 rounded">New</span>
                            </button>
                            <button className="w-full flex items-center text-sm px-3 md:px-4 py-2 text-gray-700">
